...
-- 农产品（sales 为演示初始销量；在前端下单后会累加；cover 复用 uploads 下示例图片，部分为空）
INSERT INTO product (id, name, category_id, origin_id, price, stock, unit, cover, description, sales, status, create_time) VALUES
(1,  '赣南脐橙',       1, 1,  8.80, 200, '斤', '/uploads/7f9623a25298487fb8a194b10e73e037.png', '皮薄多汁、酸甜可口，现摘现发。',        156, 1, NOW()),
(2,  '烟台红富士苹果', 1, 1,  6.50, 150, '斤', NULL,                                          '脆甜爽口，冰糖心。',                    98, 1, NOW()),
(3,  '赣南蜜桔',       1, 1,  5.80, 180, '斤', NULL,                                          '皮薄易剥、汁多味甜。',                  76, 1, NOW()),
(4,  '阳光玫瑰葡萄',   1, 1, 18.00,  90, '串', '/uploads/a536f897c369443485de5559c4e2ae57.png', '果香浓郁、脆甜无籽。',                  120, 1, NOW()),
(5,  '高山娃娃菜',     2, 3,  3.50, 120, '棵', NULL,                                          '高原种植，清脆无筋。',                  45, 1, NOW()),
(6,  '铁棍山药',       2, 3,  9.90,  90, '斤', NULL,                                          '粉糯香甜，营养丰富。',                  72, 1, NOW()),
(7,  '有机西红柿',     2, 3,  4.20, 100, '斤', NULL,                                          '沙瓤多汁，番茄味浓。',                  60, 1, NOW()),
(8,  '五常稻花香大米', 3, 2, 12.90, 300, '斤', '/uploads/7f9623a25298487fb8a194b10e73e037.png', '黑土地稻花香，软糯香甜。',              230, 1, NOW()),
(9,  '农家笨榨花生油', 3, 2, 35.00,  80, '桶', NULL,                                          '传统工艺压榨，香味浓郁。',              64, 1, NOW()),
(10, '东北玉米糁',     3, 2,  6.80, 150, '斤', NULL,                                          '颗粒饱满，粗粮细作（暂时下架）。',       50, 0, NOW()),
(11, '手工红薯粉条',   4, 1, 15.00,  60, '斤', NULL,                                          '纯红薯制作，久煮不烂。',                38, 1, NOW()),
(12, '野生黑木耳',     4, 3, 28.00,  50, '斤', '/uploads/a536f897c369443485de5559c4e2ae57.png', '山林野生，肉质厚实。',                  42, 1, NOW()),
(13, '散养土鸡蛋',     5, 4, 18.00, 200, '枚', NULL,                                          '山林散养，蛋黄饱满。',                  88, 1, NOW()),
(14, '安溪铁观音',     6, 5, 68.00,  40, '盒', NULL,                                          '高山乌龙，兰香回甘。',                  35, 1, NOW()),
(15, '信阳毛尖',       6, 5, 58.00,  45, '盒', NULL,                                          '明前嫩芽，鲜爽甘醇。',                  28, 1, NOW());
